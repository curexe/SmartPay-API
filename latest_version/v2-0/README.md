...
The endpoint /authenticate is queried to received a <b>basic token</b>.  You must generate an auth_token and include it in the Authentication HTTP header with this request.
